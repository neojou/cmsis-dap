...
SVC_4_1(rt_tsk_create, OS_TID, FUNCP, U32, void*, void*, RET_OS_TID);
SVC_0_1(rt_tsk_self, OS_TID, RET_OS_TID);
...
#define os_tsk_create_user(tsk,prio,stk,size)                                 \
                                      __rt_tsk_create(tsk, prio|(size<<8), stk, NULL)

#define os_tsk_self()                 __rt_tsk_self()


#if 0
#define os_tsk_create(tsk,prio)       _os_tsk_create((U32)rt_tsk_create,tsk,prio,NULL,NULL)
#define os_tsk_create_ex(tsk,prio,argv) __rt_tsk_create_ex((U32)rt_tsk_create,tsk,prio,NULL,argv)
...
SVC_1_0(rt_itv_set, void, U16);
SVC_0_0(rt_itv_wait, void);

#define os_dly_wait(delay_time)    __rt_dly_wait(delay_time);
#define os_itv_set(interval_time)  __rt_itv_set((U32)interval_time)
#define os_itv_wait()              __rt_itv_wait()
...
SVC_3_1(rt_evt_wait, OS_RESULT, U16, U16, BOOL, RET_OS_RESULT);
SVC_2_0(rt_evt_set, void, U16, OS_TID);
SVC_0_1(rt_evt_get, U32, RET_U32);
...
#define os_evt_wait_or(wflags,tmo)    __rt_evt_wait(wflags,tmo,__FALSE)
#define os_evt_set(evt_flags,task_id) __rt_evt_set(evt_flags, task_id)
#define os_evt_get()                  __rt_evt_get()
